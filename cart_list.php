	...
	<section class="page-section" id="menu">
        <div class="container">
        	...
        	<div class="col-lg-8">
	        		...
	        		<div class="card">
	        			<div class="card-body">
	        				<div class="row">
		        				...
		        				<div class="col-md-4 text-right"><b>Total Tsh.</b></div>
	        				</div>
	        			</div>
	        		</div>
	        	</div>
        		...
        		?>
				<?php
				$cartQuery = "SELECT cart.id AS 'id' FROM cart";
	        		...
	        		<div class="card-body">
		        		<div class="row">
			        		<div class="col-md-4" style="text-align: -webkit-center">
			        			<a href="./del.php?id=<?php echo $cartRow['id']; ?>" class="rem_cart btn btn-sm btn-outline-danger" data-id="<?php echo $row['cid'] ?>"><i class="fa fa-trash"></i></a>
			        		...
			        		<div class="col-md-4">
			        			...
			        			<p> <b><small>Unit Price Tsh. :<?php echo number_format($row['price'],2) ?></small></b></p>
			        			<p><small>QTY :</small></p>
			        		...
			        		<div class="col-md-4 text-right">
			        			<b><large> Tsh.<?php echo number_format($row['qty'] * $row['price'],2) ?></large></b>
			        		</div>
		        		</div>
	        		</div>
	        	</div>
        		...
        		<div class="sticky">
        			<div class="card">
        				<div class="card-body">
        					...
        					<hr>
        					<p class="text-right"><b>Tsh. <?php echo number_format($total,2) ?></b></p>
        					<hr>
